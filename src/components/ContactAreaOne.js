    ...
    <>
      ...
      <div className='contact-area'>
        <div className='container'>
          ...
          <div
        className='banner-area  banner-area-contact pd-bottom-100 bg-cover'
        style={{ backgroundImage: 'url("./assets/img/banner/group.png")',  backgroundSize: 'cover'}} // Adjust the background size as needed
        // height: '767px', marginTop: '-10%', width: '120%', marginLeft: '-10%'}}
      >
          <div
        className='banner-area  banner-area-contact pd-bottom-100 bg-cover'
        style={{ backgroundImage: 'url("./assets/img/banner/gray.png")',  backgroundSize: 'cover'}} // Adjust the background size as needed
        // height: '767px', marginTop: '-11.5%', width: '120%', marginLeft: '-10%'}}
      >
